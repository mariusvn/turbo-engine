...
namespace debug {
    void DebugWindow::set_color_theme() {
        ...
        colors[ImGuiCol_FrameBgHovered]         = ImVec4(0.39f, 0.39f, 0.39f, 0.40f);
        colors[ImGuiCol_FrameBgActive]          = ImVec4(0.52f, 0.52f, 0.52f, 0.67f);
        ...
        colors[ImGuiCol_SeparatorHovered]       = ImVec4(0.38f, 0.38f, 0.38f, 0.78f);
        ...
        colors[ImGuiCol_TabHovered]             = ImVec4(0.52f, 0.52f, 0.52f, 0.80f);
